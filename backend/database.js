...
async function crearBaseDeDatos() {
  try {
    ...
    const clientesData = [
      {
        curp: 'OICC900101HDFXXX01',
        nombre: 'Cristhian Olivas',
        email: 'cristhian@nexus.com'
      },
      {
        curp: 'FIIV850203HDFXXX02',
        nombre: 'Iván Figeroa',
        email: 'ivan@nexus.com'
      },
      {
        curp: 'BEMM920415MDFXXX03',
        nombre: 'María Beltran',
        email: 'maria@nexus.com'
      },
      {
        curp: 'HEHC880627HDFXXX04',
        nombre: 'Carlos Hernández',
        email: 'carlos@nexus.com'
      },
      {
        curp: 'MASO951112MDFXXX05',
        nombre: 'Sofía Martinez',
        email: 'sofia@nexus.com'
      },
      {
        curp: 'GAJJ020304HDFXXX06',
        nombre: 'Javier García',
        email: 'javier@nexus.com'
      },
      {
        curp: 'OLPA780819MDFXXX07',
        nombre: 'Patricia Olivas',
        email: 'patricia@nexus.com'
      },
      {
        curp: 'JIRO830505HDFXXX08',
        nombre: 'Roberto Jimenez',
        email: 'roberto@nexus.com'
      },
      {
        curp: 'VIPF900909HDFXXX09',
        nombre: 'Pancho Villa',
        email: 'pancho@nexus.com'
      },
      {
        curp: 'MELN751212HDFXXX10',
        nombre: 'Leonel Messi',
        email: 'leonel@nexus.com'
      },
      {
        curp: 'ROCC880303HDFXXX11',
        nombre: 'Cristhian Ronaldo',
        email: 'cristiano@nexus.com'
      },
      {
        curp: 'FODA960606HDFXXX12',
    ...
    const cuentasData = [
      {
        numero: '10001',
        cliente_curp: 'OICC900101HDFXXX01',
        saldo: 12500.00,
        tipo: 'ahorro'
      },
      {
        numero: '10002',
        cliente_curp: 'FIIV850203HDFXXX02',
        saldo: 8500.50,
        tipo: 'corriente'
      },
      {
        numero: '10003',
        cliente_curp: 'BEMM920415MDFXXX03',
        saldo: 23000.00,
        tipo: 'ahorro'
      },
      {
        numero: '10004',
        cliente_curp: 'HEHC880627HDFXXX04',
        saldo: 3400.75,
        tipo: 'corriente'
      },
      {
        numero: '10005',
        cliente_curp: 'MASO951112MDFXXX05',
        saldo: 6700.20,
        tipo: 'ahorro'
      },
      {
        numero: '10006',
        cliente_curp: 'GAJJ020304HDFXXX06',
        saldo: 18900.00,
        tipo: 'corriente'
      },
      {
        numero: '10007',
        cliente_curp: 'OLPA780819MDFXXX07',
        saldo: 550.30,
        tipo: 'ahorro'
      },
      {
        numero: '10008',
        cliente_curp: 'JIRO830505HDFXXX08',
        saldo: 13200.00,
        tipo: 'corriente'
      },
      {
        numero: '10009',
        cliente_curp: 'VIPF900909HDFXXX09',
        saldo: 9800.00,
        tipo: 'ahorro'
      },
      {
        numero: '10010',
        cliente_curp: 'MELN751212HDFXXX10',
        saldo: 4520.00,
        tipo: 'corriente'
      },
      {
        numero: '10011',
        cliente_curp: 'ROCC880303HDFXXX11',
        saldo: 30100.00,
        tipo: 'ahorro'
      },
      {
        numero: '10012',
        cliente_curp: 'FODA960606HDFXXX12',
        saldo: 7700.99,
        tipo: 'corriente'
      }
    ];
